...
class AddPlantilla extends StatefulWidget {
  @override
  _AddPlantillaViewState createState() => _AddPlantillaViewState();
}



class _AddPlantillaViewState extends State<AddPlantilla> {
  //
  List temas= [
    "Aritmética", "Algebra", "Diferencial", "Optimización"
  ];
  //User data
  String _tema;
  String _expresion;
